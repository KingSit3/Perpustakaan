        ...
        <div class="col">
            <?php if( !$peminjaman ){ ?>
                ...
                <div class="row text-center">
                    <div class="col">
                        <a class="btn btn-primary" href="/peminjaman" class="btn btn-primary text-center">Kembali</a>
                    </div>
                </div>
        ...
        <table class="table table-hover">
            ...
            <tbody class="">
                ...
                <?php foreach($peminjaman as $pinjam):  ?>
                    ...
                    <td id="button">
                    <a href="/peminjaman/detail/<?= $pinjam['id_peminjaman']; ?>" class="btn btn-primary btn-circle"><i class="fas fa-info"></i></a>
                    <a href="/peminjaman/delete/<?= $pinjam['id_peminjaman']; ?>" class="btn btn-danger tombol-hapus btn-circle"><i class="fas fa-trash"></i></a>
                    <a href="/peminjaman/pengembalian/<?= $pinjam['id_peminjaman']; ?>" class="btn btn-success btn-circle"><i class="fas fa-check"></i></a>
